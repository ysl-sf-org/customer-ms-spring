    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/customer/search").access("#oauth2.hasScope('openid')")
            .and()
            .authorizeRequests()
				.antMatchers(HttpMethod.GET, "/customer").access("#oauth2.hasScope('openid')")
				.antMatchers(HttpMethod.PUT, "/customer").access("#oauth2.hasScope('openid')")
				.antMatchers(HttpMethod.DELETE, "/customer").access("#oauth2.hasScope('openid')")
            .and()
